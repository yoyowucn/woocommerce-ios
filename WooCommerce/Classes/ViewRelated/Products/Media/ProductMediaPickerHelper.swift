...
enum MediaPickerDataSourceType {
    case device
    case mediaLibrary
}

public typealias ProductMediaPickerHelperCallback = ([WPMediaAsset]?) -> Void

class ProductMediaPickerHelper: NSObject {
...
//    }()
    ...
    var didPickMediaCallback: ProductMediaPickerHelperCallback?
...
//        self.post = post
    ...
    func presentMediaPickerFullScreen(animated: Bool,
                                      ...
                                      callback: @escaping ProductMediaPickerHelperCallback) {
...
extension ProductMediaPickerHelper: WPMediaPickerViewControllerDelegate {
